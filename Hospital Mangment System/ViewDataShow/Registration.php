...
<?php
 ...
 <fieldset style="width: 30%; margin-left: 34%">
     ...
     <form action="../ControllerCheck/RegistrationCheck.php" method="POST" novalidate>
        <div class="username">
    ...
    <div class="usertype">
      <label for="usertype" id="typelabel">User Type:</label>
      <select name="usertype" id="usertype">
        <option value="admin" id="option">Admin</option> 
